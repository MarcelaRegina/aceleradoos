...
<div className="flex justify-centergrid gap-8 ml-60 ">
 ...
 {/* QUEM SOMOS ............................................................................ */}
  ...
  {/* Imagem à esquerda */}
  <img src="/assets/Quemsomos.jpg" alt="Imagem" className="w-100 h-80 ml-40" />
  ...
  <div className="w-1/2 p-10 ml-20">
    ...
    <div className="text-lg text-gray-900 text-right font-semibold">
      ...
      <p className="mb-0">a cada dia a confiança e preferência das pessoas.</p>
    </div>

    {/* Botão "Simule Online" */}
    <button className="bg-yellow-300 rounded-full px-6 py-3 mt-4 text-gray-900 font-bold ml-80 mb-10">
      Simule Online
    </button>
  </div>
</div>
...
<div class="text-center mt-16">
  ...
  <h2 classname="bg-gray-900 text-5xl font-semibold bg-gray-900 inline-block py-1 px-4">
    Depoimentos de Clientes
  </h2>
 
  <div class="bg-gray-900 h-1 w-16 mx-auto my-2"></div>


  <div class="flex justify-center items-start mt-4">
 
    <div class="text-gray-900 text-left px-40">
      <p class="mb-4">"A Equipe é muito prestativa, competente e sempre me auxilia nos momentos em que preciso tomar decisões importantes sobre proteção para o meu patrimônio e para minha família."</p>
    </div>
 
    <div class="bg-gray-500 h-20 w-1 mx-4 my-2"></div>
    
    <div class="text-gray-900 text-left px-4">
      <p class="mb-4">"Sou cliente há alguns anos, e desde o início, o que mais me agradou é ter um atendimento humano de qualidade e tecnologia para contratar um seguro de maneira simples e rápida."</p>
    </div>
 
    <div class="bg-gray-500 h-20 w-1 mx-4 my-2"></div>

    <div class="text-gray-900 text-left px-4">
      <p class="mb-4">"Explicam de uma forma clara e objetiva, me auxiliam nas dúvidas e estão dispostos a fazer sempre o melhor para nós consumidores. Amo e recomendo!"</p>
    </div>
  </div>
</div>
